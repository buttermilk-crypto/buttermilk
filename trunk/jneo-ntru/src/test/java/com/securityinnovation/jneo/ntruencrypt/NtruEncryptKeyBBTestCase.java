...
public class NtruEncryptKeyBBTestCase {
	...
	public void test_genKey_nullOID() throws NtruException {
		NtruEncryptKey.genKey(null, defaultPrng);
	}

	// Implements test case NGK-3.
	@Test(expected = NullPointerException.class)
	public void test_genKey_nullRandom() throws NtruException {
		NtruEncryptKey.genKey(OID.ees401ep1, (Random) null);
	}

	// Implements test case NGK-1.
	@Test
	public void test_genKey_knownInput() throws NtruException {
	...
	@Test(expected = NullPointerException.class)
	public void test_constructor_keyBlob_null() throws NtruException {
		new NtruEncryptKey((byte[]) null);
	}

	// Implements test case NEK-2.
	@Test(expected = FormatNotSupportedException.class)
	public void test_constructor_bad_tag() throws NtruException {
		byte blob[] = null;
		try {
			// Get test vector
	...
	public void test_constructor_bad_oid() throws NtruException {
		byte blob[] = null;
		try {
			// Get test vector
			NtruEncryptTestVector test = tests[0];
	...
	public void test_constructor_blob_short() throws NtruException {
		byte blob[] = null;
		try {
			// Get test vector
			NtruEncryptTestVector test = tests[0];
	...
	@Test(expected = IllegalArgumentException.class)
	public void test_constructor_blob_long() throws NtruException {
		byte blob[] = null;
		try {
			// Get test vector
			NtruEncryptTestVector test = tests[0];
	...
	public void test_getPubKey_closed() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
			k = new NtruEncryptKey(getPubKeyBlob(test));
	...
	@Test
	public void test_getPubKey_known_value() throws NtruException {
		for (OID oid : OID.values()) {
			NtruEncryptTestVector test = findTest(oid);
	...
	@Test(expected = ObjectClosedException.class)
	public void test_getPrivKey_closed() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
	...
	public void test_getPrivKey_noPrivKey() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
			k = new NtruEncryptKey(getPubKeyBlob(test));
	...
	@Test
	public void test_getPrivKey_known_value() throws NtruException {
		for (OID oid : OID.values()) {
			NtruEncryptTestVector test = findTest(oid);
	...
	@Test(expected = ObjectClosedException.class)
	public void test_encrypt_closed() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
			k = new NtruEncryptKey(getPubKeyBlob(test));
	...
	@Test(expected = NullPointerException.class)
	public void test_encrypt_nullPlaintext() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
			k = new NtruEncryptKey(getPubKeyBlob(test));
	...
	@Test(expected = NullPointerException.class)
	public void test_encrypt_nullPrng() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
			k = new NtruEncryptKey(getPubKeyBlob(test));
	...
	public void test_encrypt_messageTooLong() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
			k = new NtruEncryptKey(getPubKeyBlob(test));
	...
	public void test_encrypt_known_value() throws NtruException {
		for (OID oid : OID.values()) {
			NtruEncryptTestVector test = findTest(oid);
	...
	@Test(expected = ObjectClosedException.class)
	public void test_decrypt_closed() throws NtruException {
		NtruEncryptKey k = null;
		byte ct[] = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
	...
	@Test(expected = NullPointerException.class)
	public void test_decrypt_nullCipherText() throws NtruException {
		NtruEncryptKey k = null;
		try {
			NtruEncryptTestVector test = findTest(OID.ees401ep1);
			k = new NtruEncryptKey(getPrivKeyBlob(test));
	...
	public void test_decrypt_ciphertext_short() throws NtruException {
		NtruEncryptTestVector test = tests[0];
	...
	@Test(expected = CiphertextBadLengthException.class)
	public void test_decrypt_ciphertext_long() throws NtruException {
		NtruEncryptTestVector test = tests[0];
		NtruEncryptKey k = new NtruEncryptKey(getPrivKeyBlob(test));
		byte ct[] = new byte[test.packedE.length + 1];
	...
	public void test_decrypt_bad_ciphertext() throws NtruException {
		NtruEncryptTestVector test = tests[0];
		NtruEncryptKey k = new NtruEncryptKey(getPrivKeyBlob(test));
	...
	@Test(expected = DecryptionFailureException.class)
	public void test_decrypt_bad_key() throws NtruException {
		NtruEncryptTestVector test = tests[0];
	...
	@Test(expected = NoPrivateKeyException.class)
	public void test_decrypt_noPrivateKey() throws NtruException {
		NtruEncryptTestVector test = tests[0];
		NtruEncryptKey k = new NtruEncryptKey(getPubKeyBlob(test));
		k.decrypt(test.packedE);
	}
	...
	@Test
	public void test_decrypt_known_value() throws NtruException {
		for (OID oid : OID.values()) {
			NtruEncryptTestVector test = findTest(oid);
			NtruEncryptKey k = new NtruEncryptKey(getPrivKeyBlob(test));
	...
	boolean runFullTest(OID oid) throws NtruException {
	...
	@Test
	public void test_positive() throws NtruException {
		for (OID oid : OID.values())
			assertTrue(runFullTest(oid));
	}

	// Find a test vector for the specified parameter set.
	NtruEncryptTestVector findTest(OID oid) {

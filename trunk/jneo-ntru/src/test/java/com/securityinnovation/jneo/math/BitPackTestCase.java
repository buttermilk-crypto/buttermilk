...
public class BitPackTestCase {
	...
	@Test
	public void test_pack_getLength() {
		assertEquals(12, BitPack.pack(12, 0x100, null, 0, null, 0));
		assertEquals((12 * 9 + 7) / 8,
				BitPack.pack(12, 0x200, null, 0, null, 0));
		assertEquals((14 * 10 + 7) / 8,
				BitPack.pack(14, 0x400, null, 0, null, 0));
		assertEquals((21 * 11 + 7) / 8,
				BitPack.pack(21, 0x800, null, 0, null, 0));
		assertEquals((13 * 12 + 7) / 8,
				BitPack.pack(13, 0x1000, null, 0, null, 0));
		assertEquals((19 * 13 + 7) / 8,
				BitPack.pack(19, 0x2000, null, 0, null, 0));
		assertEquals((19 * 14 + 7) / 8,
				BitPack.pack(19, 0x4000, null, 0, null, 0));
		assertEquals((19 * 15 + 7) / 8,
				BitPack.pack(19, 0x8000, null, 0, null, 0));
		assertEquals((19 * 16 + 7) / 8,
				BitPack.pack(19, 0x10000, null, 0, null, 0));
	}

	@Test
	public void test_pack5() {
		...
		assertEquals(tgt.length, BitPack.pack(src.length, 0x20, src, 0, tgt, 0));
	...
	public byte[] maskToBytes(short s[]) {
	...
	@Test
	public void test_pack9_limited() {
		short src[] = { 0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88 };
	...
	@Test
	public void test_pack12_limited() {
		short src[] = { 0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88 };
		byte exptgt[] = { (byte) 0x08, (byte) 0x00, (byte) 0x81, (byte) 0x08,
				(byte) 0x20, (byte) 0x83 };
		byte tgt[] = new byte[exptgt.length];
	...
	private byte[] subArray(byte a[], int fromIndex, int toIndex) {
	...
	public void test_pack12_long() {
		...
		assertEquals(exptgt.length,
				BitPack.pack(src.length, 0x1000, tgt.length, src, 0, tgt, 0));
		// Verify the output

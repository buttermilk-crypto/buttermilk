...
/**
 * This exception indicates that the input key blob contains a key that uses an
 * NtruEncrypt or NtruSign parameter set that is not supported by this
 * implementation.
 */
public class ParamSetNotSupportedException extends NtruException {
	...
	/**
	 * Constructs a new exception with the supplied OID's name as the detail
	 * message.
	 */

...
public class KeyVaultDatabase {
	...
	/**
	 * Open all storage containers, indices, and catalogs in the given folder
	 */
	public KeyVaultDatabase(String rootDirectory)
	...
	private static class RegHandleKeyCreator extends SerialSerialKeyCreator {
		...
		public Object createSecondaryKey(Object primaryKey, Object data) {
			...
			return new Handle(meta.getHandle());
		}
	}

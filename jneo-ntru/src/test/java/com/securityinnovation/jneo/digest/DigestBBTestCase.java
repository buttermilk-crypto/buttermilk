...
public class DigestBBTestCase {
	...
	@Test
	public void test_digest_inputLength_zero() {
		Sha1 s = new Sha1();
	...
	@Test
	public void test_digest_existing_state() {
		Sha1 s = new Sha1();
	...
	// digest: known-value tests
	@Test
	public void test_digest_resetOnReturn() {
		Sha1 s = new Sha1();
		s.digest(randBytes, 4, 10, outbuf, 0);
	...
	@Test
	public void test_finishDigest_resets_object() {
		Sha1 s = new Sha1();

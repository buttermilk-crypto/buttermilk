...
public class KeyFormatterUtilTestCase {
	...
	@Test
	public void test_fillHeader() throws NtruException {
		byte oid[] = { 2 };
	...
	@Test
	public void test_fillHeader2() throws NtruException {
		byte oid[] = { 2, 9, 6 };
		byte out[] = new byte[oid.length + 1];
		java.util.Arrays.fill(out, (byte) 0);
	...
	@Test
	public void test_fillHeader_noOutput() throws NtruException {
		byte oid[] = { 2, 9, 6 };
		assertEquals(4, KeyFormatterUtil.fillHeader((byte) 3, oid, null));
	}

	@Test(expected = IllegalArgumentException.class)
	public void test_short_buffer() throws ParamSetNotSupportedException {
	...
	public void test_parseOID_bad_oid() throws ParamSetNotSupportedException {
		byte inData[] = new byte[10];
		java.util.Arrays.fill(inData, (byte) 0);
		KeyFormatterUtil.parseOID(inData, 1, 2);
	}

	boolean checkOID(OID oid) throws NtruException {
		byte inData[] = new byte[10];
		java.util.Arrays.fill(inData, (byte) 0);
	...
	@Test
	public void test_parseOID_ok() throws NtruException {
	...
	@Test
	public void test_recoverF() throws NtruException {

...
public class FullPolynomialTestCase {
	...
	public void test_basic_convolution_x1() {
		...
		FullPolynomial p = FullPolynomial.convolution(new FullPolynomial(
				aCoeffs), new FullPolynomial(bCoeffs));
	...
	public void test_addAndRecenter() throws ParamSetNotSupportedException {
		...
		for (int t = 0; t < tests.length; t++) {
			...
			FullPolynomial out = FullPolynomial.addAndRecenter(mask, Mtrin,
					keyParams.p, -1);
	...
	public void test_subtractAndRecenter() throws ParamSetNotSupportedException {
		...
		for (int t = 0; t < tests.length; t++) {
			...
			FullPolynomial out = FullPolynomial.subtractAndRecenter(mP, mask,
					keyParams.p, -1);

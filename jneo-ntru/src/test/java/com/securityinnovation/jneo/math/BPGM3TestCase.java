...
public class BPGM3TestCase {
	...
	public void test_oddeven() {
		byte igfSequence[] = { 0, 0, 0, 2, 0, 4, 0, 6, 0, 8, 0, 1, 0, 3, 0, 5,
				0, 7, 0, 9 };
	...
	public void test_collisions() {
		byte igfSequence[] = { 0, 0, 0, 2, 0, 4, 0, 6, 0, 0, 0, 2, 0, 4, 0, 6,
				0, 8, 0, 0, 0, 2, 0, 4, 0, 6, 0, 8, 0, 1, 0, 3, 0, 5, 0, 7, 0,
				9 };
		ByteArrayInputStream is = new ByteArrayInputStream(igfSequence);
		IGF2 igf = new IGF2(0x7fff, 16, is);
	...
	public void test_genr() throws ParamSetNotSupportedException {
		...
		for (int t = 0; t < tests.length; t++) {
			...
			IGF2 igf = new IGF2(keyParams.N, keyParams.c, keyParams.igfHash, 1,
					tests[t].sData, 0, tests[t].sData.length);
			FullPolynomial out = BPGM3.genTrinomial(keyParams.N, keyParams.dr,
					keyParams.dr, igf);

 ...
 *  essentially like the below. It can read only the For Publication mode of a DSA Key.
 * </p>
 * 
 * 
 * @author Dave
 ...
 * 
 */
public class JSONDSAKeyForPublicationReader {
	
	protected final ObjectMapper mapper;
	protected final Map<String,Object> map;
	 
	@SuppressWarnings("unchecked")
	public JSONDSAKeyForPublicationReader(Reader in) {
	...
	@SuppressWarnings("unchecked")
	public JSONDSAKeyForPublicationReader(String in) {
		mapper = new ObjectMapper();
		try {
			map = mapper.readValue(in, Map.class);
		} catch (Exception e) {
	...
	@SuppressWarnings("unchecked")
	public DSAKeyForPublication parse() {
		...
		if (iter.hasNext()) {
			...
			if (distUUID.endsWith("-P")) {
				...
				ArmoredString Q = new ArmoredString(String.valueOf(inner.get("Q")));
				ArmoredString G = new ArmoredString(String.valueOf(inner.get("G")));
				ArmoredString Y = new ArmoredString(String.valueOf(inner.get("Y")));

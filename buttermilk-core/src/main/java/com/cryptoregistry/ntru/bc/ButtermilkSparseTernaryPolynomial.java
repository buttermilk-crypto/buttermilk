 ...
 */
public class ButtermilkSparseTernaryPolynomial implements TernaryPolynomial {
	/**
	 * Number of bits to use for each coefficient. Determines the upper bound
	 * for <code>N</code>.
	 */
	 ...
	 *            indices of coefficients equal to -1
	 */
	public ButtermilkSparseTernaryPolynomial(int N, int[] ones, int[] negOnes) {
		this.N = N;
		this.ones = ones;
	...
	/**
	 * Constructs a <code>DenseTernaryPolynomial</code> from a
	 * <code>IntegerPolynomial</code>. The two polynomials are independent of
	 * each other.
	 *
	 * @param intPoly
	 *            the original polynomial
	 */
	public ButtermilkSparseTernaryPolynomial(IntegerPolynomial intPoly) {
		this(intPoly.coeffs);
	}

	/**
	 * Constructs a new <code>SparseTernaryPolynomial</code> with a given set of
	 * coefficients.
	 *
	 * @param coeffs
	 *            the coefficients
	 */
	public ButtermilkSparseTernaryPolynomial(int[] coeffs) {
		N = coeffs.length;
		ones = new int[N];
		negOnes = new int[N];
		int onesIdx = 0;
	 ...
	 *
	 * @param is
	 *            an input stream containing an encoded polynomial
	 * @param N
	 ...
	 * @throws IOException
	 */
	public static ButtermilkSparseTernaryPolynomial fromBinary(InputStream is,
			int N, int numOnes, int numNegOnes) throws IOException {
		...
		return new ButtermilkSparseTernaryPolynomial(N, ones, negOnes);
	}

	/**
	 * Generates a random polynomial with <code>numOnes</code> coefficients
	 * equal to 1, <code>numNegOnes</code> coefficients equal to -1, and the
	 * rest equal to 0.
	 *
	 * @param N
	 ...
	 *            number of -1's
	 */
	public static ButtermilkSparseTernaryPolynomial generateRandom(int N,
			int numOnes, int numNegOnes, SecureRandom random) {
		int[] coeffs = Util.generateRandomTernary(N, numOnes, numNegOnes,
				random);
		return new ButtermilkSparseTernaryPolynomial(coeffs);
	}
	 ...
	 * <code>BITS_PER_INDEX</code> bits for each coefficient.
	 *
	...
	public boolean equals(Object obj) {
		...
		ButtermilkSparseTernaryPolynomial other = (ButtermilkSparseTernaryPolynomial) obj;
		if (N != other.N) {
			return false;
		}
	...
	/**
	 * Not implemented, BigIntPolynomial has non-visible members
	 */
	@Override

...
/**
 * This is a complete reworking for BC's RSAKeyPairGenerator because it is not really a good candidate as a base class.
 * 
 * @author Dave
 *
 */

public class ButtermilkRSAKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
		...
		public ButtermilkRSAKeyPairGenerator() {
			super();
		}

		public ButtermilkRSAKeyPairGenerator(char[] password) {
			super();
			this.password = password;
		}
		
		public ButtermilkRSAKeyPairGenerator(RSAKeyMetadata management) {
			super();
		...
		public RSAKeyGenerationParameters getParam() {
			return param;
		}
